...
namespace SampleInventory
{
    public partial class Supplier : Form
    {
        ...
        private void ClearFIELD()
        {
            ...
            SODRFIELD.Text = null;
            NoteFIELD.Text = null;
            CheckedFIELD.Text = null;
        }

        // SWITCHING ////////////////////////
        private void OFFFIELD()
        {
            SupplierFIELD.Enabled = false;
        ...
        private void BoxgetData(AutoCompleteStringCollection dataCollection2)
        {
            ...
            string sql = "Select distinct [Name] from [Transaction] where Type = 'Import'";
        ...
        private void BoxLoadData()
        {
            ...
            t.Fill(ts);
            SQLLoad.con.Close();
            SPLRBindingSource.DataSource = ts;
            ts.DefaultView.Sort = "ID";
            SupplierFIELD.AutoCompleteMode = AutoCompleteMode.Suggest;
            SupplierFIELD.AutoCompleteSource = AutoCompleteSource.CustomSource;
            AutoCompleteStringCollection DataCollection2 = new AutoCompleteStringCollection();
            BoxgetData(DataCollection2);
            SupplierFIELD.AutoCompleteCustomSource = DataCollection2;
        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (numRecords == 0)
                            {
                                ...
                                savecmdTR.Parameters.AddWithValue("@Name", SupplierFIELD.Text);
                                ...
                                savecmdTR.Parameters.AddWithValue("@Type", "Import");
                                ...
                                savecmdTL.Parameters.AddWithValue("@Name", SupplierFIELD.Text);
                                ...
                                savecmdTL.Parameters.AddWithValue("@Type", "Import");
                                ...
                                savecmdIH.Parameters.AddWithValue("@Customer", SupplierFIELD.Text);
                                ...
                                savecmdIH.Parameters.AddWithValue("@Type", "Import");
        ...
        private void SaveBTN_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Proceed to save?", "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Please fill the Checked by.", "Message");
                    }
                    else
                    {
                        if (PickupGridView.Rows.Count > 0 && PickupGridView.Rows != null)
                        {
                            ...
                            savecmd.Parameters.AddWithValue("@Name", SupplierFIELD.Text);
                            savecmd.Parameters.AddWithValue("@Address", AddressFIELD.Text);
                            savecmd.Parameters.AddWithValue("@Reference", SODR.ToString());
                            savecmd.Parameters.AddWithValue("@Employee", CheckedFIELD.Text);
                            ...
                            savecmd.Parameters.AddWithValue("@Type", "Import");
                            ...
                            ItemHistory = null;
                            CatchData.REPID = TID;
                            CatchData.REPNAME = SupplierFIELD.Text;
                            CatchData.REPSODR = SODR.ToString();
                            CatchData.REPEMPLOYEE = CheckedFIELD.Text;
