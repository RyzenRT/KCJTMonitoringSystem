...
namespace SampleInventory
{
    public partial class Pickup : Form
    {
        ...
        private void ClearFIELD()
        {
            ...
            NoteFIELD.Text = null;
            ReleaseFIELD.Text = null;
        }
        // SWITCHING ////////////////////////
        private void OFFFIELD()
        {
            CustomerFIELD.Enabled = false;
        ...
        private void BoxLoadData()
        {
            ...
            t.Fill(ts);
            SQLLoad.con.Close();
            TESTBindingSource.DataSource = ts;
            ts.DefaultView.Sort = "ID";
            CustomerFIELD.AutoCompleteMode = AutoCompleteMode.Suggest;
            CustomerFIELD.AutoCompleteSource = AutoCompleteSource.CustomSource;
            AutoCompleteStringCollection DataCollection = new AutoCompleteStringCollection();
            BoxgetData(DataCollection);
            CustomerFIELD.AutoCompleteCustomSource = DataCollection;
        }
        // FILTER ITEM DATA /////////////////////////////////////////////
        ...
        private void RNGTL()
        {
            try
            {
                ...
                else
                {
                    ...
                    int TLID = int.Parse(dt.Rows[0][0].ToString());
        ...
        private void InfoSaveBTN_Click(object sender, EventArgs e)
        {
            try
            {
                SODRS = SPLRFIELD.Text + YEARFIELD.Text + "-" + SODRFIELD.Text;
                ...
                CountCmd.Parameters.AddWithValue("@Customer", CustomerFIELD.Text);
                CountCmd.Parameters.AddWithValue("@Reference", SODRS.ToString());
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (numRecords == 0)
                            {
                                ...
                                savecmdTR.Parameters.AddWithValue("@Name", CustomerFIELD.Text);
                                ...
                                savecmdTR.Parameters.AddWithValue("@Type", "Export");
                                ...
                                savecmdTL.Parameters.AddWithValue("@Name", CustomerFIELD.Text);
                                ...
                                savecmdTL.Parameters.AddWithValue("@Type", "Export");
                                ...
                                savecmdIH.Parameters.AddWithValue("@Customer", CustomerFIELD.Text);
                                savecmdIH.Parameters.AddWithValue("@RefNumber", SODRS.ToString());
                                ...
                                savecmdIH.Parameters.AddWithValue("@Type", "Export");
        ...
        private void SaveBTN_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Proceed to save?", "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    else if (ReleaseFIELD.Text == "")
                    {
                        MessageBox.Show("Please fill the Release by.", "Message");
                    }
                    else
                    {
                        if (PickupGridView.Rows.Count > 0 && PickupGridView.Rows != null)
                        {
                            ...
                            savecmd.Parameters.AddWithValue("@Name", CustomerFIELD.Text);
                            savecmd.Parameters.AddWithValue("@Address", AddressFIELD.Text);
                            savecmd.Parameters.AddWithValue("@Reference", SODRS.ToString());
                            savecmd.Parameters.AddWithValue("@Employee", ReleaseFIELD.Text);
                            ...
                            savecmd.Parameters.AddWithValue("@Type", "Export");
                            ...
                            ItemHistory = null;
                            CatchData.REPID = TID;
                            CatchData.REPNAME = CustomerFIELD.Text;
                            CatchData.REPSODR = SPLRFIELD.Text + YEARFIELD.Text + "-" + SODRFIELD.Text;
                            CatchData.REPEMPLOYEE = ReleaseFIELD.Text;
        ...
        private void SOFIELD_MouseDown(object sender, MouseEventArgs e)
        {
