...
namespace SampleInventory
{
    public partial class Return : Form
    {
        ...
        private void BoxLoadData()
        {
            ...
            t.Fill(ts);
            SQLLoad.con.Close();
            RTRNBindingSource.DataSource = ts;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (numRecords == 0)
                            {
                                ...
                                savecmdTR.Parameters.AddWithValue("@Type", "Return");
                                ...
                                savecmdTL.Parameters.AddWithValue("@Type", "Return");
                                ...
                                savecmdIH.Parameters.AddWithValue("@Type", "Return");
                ...
                try
                {
                    ...
                    else
                    {
                        if (PickupGridView.Rows.Count > 0 && PickupGridView.Rows != null)
                        {
                            ...
                            savecmd.Parameters.AddWithValue("@Type", "Return");
